...
then
    ...
    -o plenteum.herominers.com:10431 -u $LOKI_AD -p $PLE_AD --variant 1 -k \
    -o pool.loki.hashvault.pro:3333 -u $LOKI_AD:$TRTL_AD -p $WORKERNAME:bczmarts@gmail.com --variant 1 -k \
    -o trtl.cnpool.cc:32516 -u $TRTL_AD -p $LOKI_AD --variant 1 -k \
    -o loki.cnpool.cc:23333 -u $LOKI_AD -p $TRTL_AD --variant 1 -k \
	...
	--max-cpu-usage $CPU_USE --cpu-priority $CPU_PRI > $HOME_DIR/Desktop/mine/recordLOKIs.log 2>&1 &
